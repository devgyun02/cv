  ...
  projects: [
    {
      ...
      period: '2026',
      techStack: {
        androidUI: ['Kotlin', 'Jetpack Compose', 'Material 3', 'ViewModel', 'Coroutines'],
        network: ['Retrofit2', 'OkHttp3', 'Gson', 'Google Maps SDK', 'Geocoder'],
        backend: ['Node.js', 'Express.js', 'JWT', 'bcrypt', 'cors', 'dotenv', 'Gemini 2.5 Flash'],
        database: ['MySQL', 'mysql2 (Promise)', 'Connection Pool', 'InnoDB / FK', 'init.sql']
      },
      summary: '갑작스러운 육아/돌봄 공백 발생 시 부모(구인자)와 선생님(구직자)을 실시간 위치 기반 및 AI 태그 추출로 연결하는 돌봄 매칭 서비스',
      contents: `
