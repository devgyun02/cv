module.exports = {
  ...
  experience: [
    {
      header: 'Personal Projects (개인 프로젝트)',
      skills: ['Kotlin', 'PyTorch', 'Node.js', 'Express.js', 'MySQL', 'Streamlit'],
      contents: `
**CareConnect (맞벌이 부부 및 지역 사회 돌봄 자원 실시간 매칭 안드로이드 & AI 백엔드 플랫폼)** | *2026*
...
**AIS (AI-based Industrial Security - 산업 인프라 실시간 위협 탐지 및 이상 탐지 파이프라인)** | *2026*
...
`
    ...
    {
      header: 'Team Projects (팀 프로젝트)',
      skills: ['Node.js', 'Express.js', 'Gemini 3.1 Flash Lite', 'Algorithm Design'],
      contents: `
**uniOn (AI 기반 학내 소모임 추천 매칭 플랫폼)** | *Team 공백 / 경상국립대학교 GNU PBL II (2026)*
- **[백엔드 & 알고리즘 개발 전담]** 추천 알고리즘 전반 설계, 프로토콜 구조화 및 성능 검증 담당
